		...
		uglify: {
			min: {
				files: {
					...
					'assets/js/attorneys.min.js': ['assets/js/src/attorney-scripts.js'],
					'assets/js/testimonials.min.js': ['assets/js/src/testimonial-scripts.js'],
					'assets/js/fade.min.js': ['assets/js/src/content-fade-scripts.js'],
					'assets/js/smooth-scroll-custom.min.js': ['assets/js/src/smooth-scroll-custom.js'],
                    'assets/js/practice-parent-new-scripts.min.js': ['assets/js/src/practice-parent-new-scripts.js']
				}
			}
		},
